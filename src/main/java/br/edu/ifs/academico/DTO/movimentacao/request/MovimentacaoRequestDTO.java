...
public record MovimentacaoRequestDTO(
    ...
    public MovimentacaoRequestDTO(Long cartaoId, Long programaId, Long promocaoId, BigDecimal valor, LocalDate data) {
        this(cartaoId, programaId, promocaoId, valor, null, data);
    }
}
